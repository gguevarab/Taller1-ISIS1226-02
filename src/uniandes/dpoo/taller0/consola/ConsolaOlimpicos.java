...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país de un atleta en especifico");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	private void ejecutarNacionalidadAtleta()
	{
		String atleta = input("Escriba el nombre del atleta a consultar");
		String pais = calculadora.NacionalidadAtleta(atleta);
		if (pais != null) {
			System.out.println("El atleta " + atleta + " es del país " + pais);
		}
		else {
			System.out.println("No se encontraron atletas con el nombre " + atleta);
		}
	}
